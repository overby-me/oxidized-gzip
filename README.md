...
> [`safety/oxidized/gzip`](https://tangled.org/overby.me/overby.me/tree/main/rust/gzip) and where all development happens.
>
> It is also published on its own, as
> [tangled.org/overby.me/rust-gzip](https://tangled.org/overby.me/rust-gzip) and
> [github.com/overby-me/rust-gzip](https://github.com/overby-me/rust-gzip). Both
